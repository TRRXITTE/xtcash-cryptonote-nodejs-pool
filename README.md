...
https://github.com/TRRXITTE/xtcash-cryptonote-nodejs-pool/blob/main/deployment/NGINX%20SSL%20WEBSITE%20%26%20API  
-> Install NVM node version manager  
-> open ports from config.json  
-> start XTEnetwork high availability server  
-> start XTEservice for payment processing  
-> Install and run xtcash-cryptonote-nodejs-pool and adjust config.js in website_example  
...
```
cd xtcash-cryptonote-nodejs-pool
nvm use 11
npm install
```
